    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.multi_image_btn:
                ...
                break;
            case R.id.video_btn:
                BoxingConfig videoConfig = new BoxingConfig(BoxingConfig.Mode.VIDEO).needCamera(R.drawable.ic_boxing_camera_white).withVideoDurationRes(R.drawable.ic_boxing_play);
